...
(()=>{
  ...
  function compact(root){
    ...
    if(page&&focus&&kids)page.insertBefore(focus,kids);if(todo&&kids)kids.after(todo);if(daily){daily.classList.add('v7-daily');todo?todo.after(daily):kids?.after(daily)}

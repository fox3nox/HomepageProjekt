...
(()=>{
  ...
  function installStyle(){
    ...
    s.textContent=`
      ...
      .fc-doc-people{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.fc-doc-person{position:relative;border:1px solid var(--doc-line);border-radius:13px;padding:10px 11px;background:#fff;display:flex;align-items:center;gap:8px;min-height:42px;cursor:pointer;color:#334b69;font-size:12px;font-weight:800}.fc-doc-person input{position:absolute;opacity:0;pointer-events:none}.fc-doc-person .dot{width:9px;height:9px;border-radius:50%;background:var(--person,#7b8aa1);box-shadow:0 0 0 3px color-mix(in srgb,var(--person,#7b8aa1) 18%,transparent)}.fc-doc-person.selected{border-color:#8ab5ff;background:#edf5ff;color:#1458c7;box-shadow:inset 0 0 0 1px #c7dcff}.fc-doc-person.selected:after{content:'✓';margin-left:auto;color:#1762dc;font-size:12px}

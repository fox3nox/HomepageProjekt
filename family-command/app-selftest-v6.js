/* Family Command · read-only runtime self-test v6.11 · 2026-08-24 */
(()=>{
  ...
  function loadSixNav(){
    ...
    const s=document.createElement('script');s.dataset.fcSixNav='1';s.src='./nav-six-fix.js?v=20260824-pro611';s.onload=()=>{try{window.__fcSixNav?.ensure?.()}catch(e){}scheduleTest()};s.onerror=()=>console.error('fc_six_nav_load');document.body.appendChild(s);
  }
  function loadTomorrowScreen(){
    ...
    const s=document.createElement('script');s.dataset.fcTomorrowScreen='1';s.src='./tomorrow-screen.js?v=20260824-pro611';s.onload=()=>{loadSixNav();scheduleTest()};s.onerror=()=>console.error('fc_tomorrow_screen_load');document.body.appendChild(s);
  }
  ...
  window.fcRunSelfTest=run;updateConnection();loadTomorrowScreen();requestAnimationFrame(()=>{updateConnection();run()});
})();

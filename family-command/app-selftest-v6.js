/* Family Command · read-only runtime self-test v6.7 · 2026-08-24 */
(()=>{
  ...
  function loadTomorrowScreen(){
    if(window.__fcTomorrowScreenInstalled||document.querySelector('script[data-fc-tomorrow-screen]'))return;
    const s=document.createElement('script');s.dataset.fcTomorrowScreen='1';s.src='./tomorrow-screen.js?v=20260824-pro67';s.onload=scheduleTest;s.onerror=()=>console.error('fc_tomorrow_screen_load');document.body.appendChild(s);
  }

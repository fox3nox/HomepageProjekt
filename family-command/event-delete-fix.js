...
(()=>{
  ...
  function redraw(){
    try{window.__fcV9?.invalidate?.(['today','tomorrow','events'])}catch(e){}
    try{const active=document.querySelector('.fc9-screen.active')?.id;if(active)window.__fcV9?.render?.(active,true)}catch(e){}
  }

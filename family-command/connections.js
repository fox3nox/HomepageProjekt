...
function mailCard(mail){
  ...
  const dueLabel=i.invoice?.days===null?'':i.invoice?.days<0?('überfällig seit '+Math.abs(i.invoice.days)+' T.') : i.invoice?.days===0?'heute fällig':('fällig in '+i.invoice.days+' T.');

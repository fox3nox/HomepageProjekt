...
let snapshot={connections:[],mail:[],backgroundSync:null,syncHistory:[],backupStatus:null},busy=false,lastAuto=0;
...
function setSnapshot(j){snapshot={connections:j.connections||[],mail:j.mail||[],backgroundSync:j.background_sync??snapshot.backgroundSync??null,syncHistory:j.sync_history??snapshot.syncHistory??[],backupStatus:j.backup_status??snapshot.backupStatus??null};document.dispatchEvent(new CustomEvent('fc:connections-updated',{detail:{mail:snapshot.mail,connections:snapshot.connections,backgroundSync:snapshot.backgroundSync,syncHistory:snapshot.syncHistory,backupStatus:snapshot.backupStatus}}))}

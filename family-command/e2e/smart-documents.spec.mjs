...
try{
  ...
  assert.equal(aiCalls,1,'document analysis request must be intercepted exactly once');
  try{
    ...
    console.error('SMART_DOC_STATE',JSON.stringify({...diag,aiCalls}));
    throw error;
  }

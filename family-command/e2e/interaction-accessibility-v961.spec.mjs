...
try{
  ...
  console.log('v961-focus',JSON.stringify(focus));assert.equal(focus.id,'fc61FocusProbe');assert.equal(focus.outlineStyle,'solid');assert.ok(focus.outlineWidth>=2);assert.equal(focus.outlineColor,'rgb(37, 99, 186)');

...
assert.match(source,/20260906-v9700/);assert.equal(scripts.filter(s=>String(s.src).includes('header-structure-v9654.js')).length,1);
...
const toggle=scripts.find(s=>String(s.src).includes('today-overview-toggle-v9668.js'));assert.ok(toggle,'today overview toggle loaded');assert.equal(new URL(toggle.src,base).searchParams.get('v'),'20260906-v9700');
...
console.log('ok reference loader dedupe V9.66.9');

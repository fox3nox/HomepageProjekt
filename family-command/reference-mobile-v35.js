/* Familienzentrale V9.45 · compatibility loader for reference dashboard + global design system + professional product layer */
(()=>{
'use strict';
if(window.__fcReferenceMobileV35)return;window.__fcReferenceMobileV35=true;
const V='20260903-v9450';
